        ...
        <div className="w-full max-w-md space-y-10 relative z-10">
          ...
          <div className="pt-8 text-center border-t border-white/5">
            <p className="text-slate-500 text-[11px] font-medium uppercase tracking-[2px]">
              © {new Date().getFullYear()} Eletricom OS — Professional Maintenance
            </p>
            <div className="mt-2 flex items-center justify-center gap-3 opacity-40">
              <div className="h-px w-8 bg-slate-500" />
              <span className="text-[9px] text-slate-500 font-bold">V1.5.0</span>
              <div className="h-px w-8 bg-slate-500" />
            </div>
          </div>
        </div>
