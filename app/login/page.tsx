      ...
      <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-1.5 mb-4">
            <span className="text-xs text-gray-400 uppercase tracking-wider">Sistema de Gestão</span>
            <span className="text-sm font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Eletricom OS</span>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 text-xs">
            © {new Date().getFullYear()} <span className="font-semibold text-blue-500">Eletricom OS</span>
          </p>
