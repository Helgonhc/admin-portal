...
export default function PerformancePage() {
    ...
    async function loadPerformanceData() {
        try {
            ...
            // 3. Volume Mensal (Simulado para o exemplo, mas pronto para dados reais)
            const monthlyData = [
    ...
    return (
        <div className="space-y-6 animate-fadeIn pb-10">
            ...
            <div className="card dark:bg-gray-900 border-none shadow-sm overflow-hidden">
                <div className="p-4 border-b dark:border-gray-800">
                    <h3 className="font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2">
                        <TrendingUp size={18} className="text-emerald-500" /> Crescimento de Atendimentos
                    </h3>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="card dark:bg-gray-900 border-none shadow-sm p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-3xl font-bold dark:text-gray-100">4h 15m</p>
                    <p className="text-sm text-gray-500">Tempo Médio de Atendimento</p>
                    <span className="mt-2 text-xs text-emerald-600 font-medium">↓ 12% vs mês anterior</span>
                </div>
                ...
                <div className="card dark:bg-gray-900 border-none shadow-sm p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-3xl font-bold dark:text-gray-100">94.2%</p>
                    <p className="text-sm text-gray-500">Taxa de Conclusão no Prazo</p>
                    <span className="mt-2 text-xs text-emerald-600 font-medium">↑ 3.4% vs mês anterior</span>
                </div>
                ...
                <div className="card dark:bg-gray-900 border-none shadow-sm p-6 flex flex-col items-center text-center">
                    ...
                    <p className="text-3xl font-bold dark:text-gray-100">12%</p>
                    <p className="text-sm text-gray-500">Taxa de Reabertura de Chamados</p>
                    <span className="mt-2 text-xs text-rose-600 font-medium">↑ 2.1% vs mês anterior</span>
                </div>
            </div>
        </div>
    );
